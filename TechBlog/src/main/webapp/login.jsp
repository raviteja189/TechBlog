...
<style>
  .banner{
      clip-path: polygon(30% 0%, 70% 0%, 100% 0, 100% 81%, 62% 100%, 26% 84%, 0 100%, 0 0);
  }
</style>
</head>
<body>
                ...
                <div class="col-md-4 offset-md-4">
					...
					<div class="card-body">
						<form action="LoginServlet" method="post">
							...
							<div class="container"><button type="submit" class="btn btn-primary text-center">Submit</button></div>
